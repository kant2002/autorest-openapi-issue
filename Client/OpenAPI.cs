...
namespace Openapi
{
    ...
    public partial class OpenAPI : ServiceClient<OpenAPI>, IOpenAPI
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the OpenAPI class.
        /// </summary>
        /// <param name='httpClient'>
        /// HttpClient to be used
        /// </param>
        /// <param name='disposeHttpClient'>
        /// True: will dispose the provided httpClient on calling OpenAPI.Dispose(). False: will not dispose provided httpClient</param>
        public OpenAPI(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// </param>
        public OpenAPI(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public OpenAPI(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public OpenAPI(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public OpenAPI(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        public async Task<HttpOperationResponse<string>> CreatePatientWithHttpMessagesAsync(int code, bool isvalid2, string address1 = default(string), string address2 = default(string), string city = default(string), int? departmentid = default(int?), bool? isvalid = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("isvalid", isvalid);
                tracingParameters.Add("isvalid2", isvalid2);
            ...
            if(isvalid != null)
            {
                values.Add(new KeyValuePair<string,string>("isvalid", isvalid));
            }
            if(isvalid2 != null)
            {
                values.Add(new KeyValuePair<string,string>("isvalid2", isvalid2));
            }
